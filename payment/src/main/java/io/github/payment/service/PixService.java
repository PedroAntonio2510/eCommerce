package io.github.payment_system.service;

import br.com.efi.efisdk.EfiPay;
import br.com.efi.efisdk.exceptions.EfiPayException;
import io.github.payment_system.dto.PixChargeRequest;
import io.github.payment_system.pix.Credentials;
...
public class PixService {
    ...
    public JSONObject pixCreateCharge(PixChargeRequest pixChargeRequest) {
        ...
        try {
            EfiPay efi = new EfiPay(options);
            JSONObject response = efi.call("pixCreateImmediateCharge",
